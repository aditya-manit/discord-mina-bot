...
client.on('message', async (message) => {
  ...
  if (message.content.startsWith(PREFIX)) {
    ...
    if (CMD_NAME.toLowerCase() === 'mina') {
      ...
      message.channel.send('There is no annoucement of sale at the momement, keep an eye on announcement channel.\n' +
          'Meanwhile you can read the tokenomic here: https://minaprotocol.com/blog/mina-token-distribution-and-supply ')
    }
    else if (CMD_NAME.toLowerCase() === 'earn') {
      message.channel.send('There is an ongoing community channel. Top 25 will earn 20k Mina Tokens, To take part refer:\n' +
